...
Public Class frmSettings
    ...
    Public ReadOnly Property dir() As String
        Get
            Dim di As New DirectoryInfo(String.Format("{0}\medatech\", Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)))
            If Not di.Exists Then di.Create()
            Return di.FullName 'My.Application.Info.DirectoryPath
        End Get
    End Property
